      ...
      <section
        ...
        <div className="mx-auto max-w-6xl w-full px-8 min-h-screen flex flex-col md:flex-row items-center">
          ...
          <div className="flex-1 w-full flex flex-col items-center min-h-[400px]">
            ...
            {/* KPIs pushed to bottom of right column */}
      ...
      <section id="skills" className="scroll-mt-24 bg-[#333333] py-16">
        <div className="mx-auto max-w-6xl w-full px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            {/* Software engineering skill card*/}
            ...
            {/* infrastructure skill card */}
            <div className="rounded-3xl bg-slate-900/90 text-white p-8 shadow-xl">
              <div className="flex items-center gap-4 mb-6">
                <h3 className="text-2xl font-bold">Infrastructure, Networking & Security</h3>
              </div>
      ...
      <section id="projects" className="scroll-mt-24 bg-[#333333] py-20">
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            {/* main project card spans both columns */}
            ...
            {/* good but not main project cards */}
            <ProjectCard
            ...
            items={[
              {
                ...
                date: "Planned 2026",
                badgeSrc: "/certs/AWS_Cloud_Practitioner.png",
              },
              {
                title: "Microsoft Azure AI Fundamentals (AL-900)",
                issuer: "Microsoft",
                date: "Planned 2026",
                badgeSrc: "/certs/Microsoft_Azure_AI_Fundamentals.png",
              },
              {
                title: "IBM Data Science Professional Certificate",
                issuer: "IBM / Coursera",
                date: "Achieved 2024",
                badgeSrc: "/certs/IBM_Data_Science.png",
              },
              {
                title: "IBM Data Analyst Professional Certificate",
                issuer: "IBM / Coursera",
                date: "Achieved 2024",
                badgeSrc: "/certs/IBM_Data_Analyst.png",
              },
            ]}/>
        </div>
      </section>
